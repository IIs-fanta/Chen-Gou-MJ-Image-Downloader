...
const ICON_PATH = chrome.runtime.getURL('icons/logo.ico');
...
function addButtonsToImageWrapper(imageElementWrapper, detectedImageUrl) {
    ...
    downloadBtn.onclick = async (e) => {
        ...
        try {
            ...
            await downloadImage(shareableCdnUrl, fileName);
    ...
    copyLinkBtn.onclick = async (e) => {
        ...
        try {
            await navigator.clipboard.writeText(shareableCdnUrl);
            ...
            try {
                ...
                textArea.value = shareableCdnUrl;
                ...
                console.error('复制链接失败（降级方案也失败）:', fallbackError);
